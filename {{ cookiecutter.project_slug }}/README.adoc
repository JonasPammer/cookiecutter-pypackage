...
I recommend you to install it using https://github.com/pypa/pipx[pipx],
a tool that help you installing and running end-user applications written in Python
...
== Extra: Running without Installing
See link:README-DOCKER.adoc[DOCKER].
